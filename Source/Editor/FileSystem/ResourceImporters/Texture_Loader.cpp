...
namespace TuranEditor {
	...
	Resource_Identifier* Texture_Loader::Import_Texture(const char* PATH, const bool& flip_vertically, const GFX_API::Texture_Properties& Properties) {
		GFX_API::TEXTURE_CHANNELs CHANNEL_TYPE = GFX_API::TEXTURE_CHANNELs::API_TEXTURE_RGBA;
		...
		case 0:
			...
			return nullptr;
		case 1:
			CHANNEL_TYPE = GFX_API::TEXTURE_CHANNELs::API_TEXTURE_ALPHA;
			break;
		case 2:
			CHANNEL_TYPE = GFX_API::TEXTURE_CHANNELs::API_TEXTURE_RA;
			break;
		case 3:
		...
		texture_resource->Properties.VALUE_TYPE = Properties.VALUE_TYPE;
